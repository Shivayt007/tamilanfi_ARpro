...
<b>I can provide Movies. A Telegram Auto Filter Bot. \n\n🔗Join Us : @tamil_links_official \n\n🔥வாழ்க தமிழ் வளர்க தமிழ்🔥:)
    ...
    ABOUT_TXT = """<b>➥ My name: Auto_Filter_IMDB
➥ Creator(Modified): TRVPN_TEAM
➥ Library          : Pyrogram
➥ Language         : Python 𝟹
➥ Data Base        : AWS
➥ Bot Server       : AWS
➥ Build Status: v2.0.1.3 [ TESTING ]"""
...
• These commands can be used by any group member."""
    ...
    LOG_TEXT_G = """#Bot is To NewGroup 
<b>🥇Group</b> = {}(<code>{}</code>)
<b>Total Members</b> = <code>{}</code>
<b>☃️Added By</b> - {}
<b>🔥Modified By</b> - @Trvpn _ Team
"""

    LOG_TEXT_P = """#NewUser To Channel
<b>🥇ID</b> - <code>{}</code>
<b>☃️Name</b> - {}
<b>🔥Modified By</b> - @Trvpn _ Team"""
